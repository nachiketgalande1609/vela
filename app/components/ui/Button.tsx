...
const variantClasses: Record<Variant, string> = {
  ...
  gold:      'bg-[var(--accent)] text-black hover:bg-[var(--accent-hover)] active:opacity-90 focus-visible:ring-[var(--accent)]',
}
...
export function Button({ variant = 'primary', loading, children, className = '', disabled, ...props }: ButtonProps) {
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-[4px] px-4 py-2.5 text-sm font-medium
        transition-colors duration-150 active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2
